...
export default function Footer() {
  return (
    <div className='flex flex-col p-14 py-0 '>
        ...
        <div className=' flex md:gap-10 gap-5 justify-center w-full mt-5 '>
            <img className='self-start' src='logo.svg'></img><span className='flex items-center justify-center'>Copyright &copy; 2024 Metreecs</span>
        </div>
    </div>
  )
}
